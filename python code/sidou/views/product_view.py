...
class ProductView(QWidget):
    ...
    def add_new_product(self):
        ...
        try:
            add_product(name, category, description, purchase_price, selling_price)
            self.clear_form()
            self.load_products()
            self.load_categories()
            self.product_updated.emit()  # Emit signal when product is added
    ...
    def update_selected_product(self):
        ...
        try:
            ...
            self.load_products()
            self.load_categories()
            self.product_updated.emit()  # Emit signal when product is updated
            QMessageBox.information(
